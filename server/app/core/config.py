...
必须包含字段：
{
  ...
  "中文caption建议": "必须以 trigger token 开头，用两到四句详细但精确地描述可见主体、具体姿态动作、身体体态、手臂和手部动作、腿部和脚部位置、构图视角、场景物件、光线色彩和风格特征",
  "剔除原因": []
}
...
- 如果图片用于人物、人体姿势或风格 LoRA，caption 必须描述可复现的姿势细节：站立/坐姿/跪姿/蹲姿/躺姿/前倾/后仰/扭转，躯干朝向和弯曲，头部朝向，肩膀和髋部角度，手臂抬起/弯曲/支撑/交叉/下垂，手掌或手指动作，双腿伸直/弯曲/交叉/跪地/踩地，重心落点和视角。
- 如果同一张图包含多个人物或多幅姿势小图，必须按“左侧/中间/右侧/上方/下方/第一个/第二个”等位置逐个描述；不要只写“四幅不同姿势”“多种手部动作”这类概括。
- 姿势素材的 caption 至少 80 个汉字；如果有多幅姿势小图，每个可见姿势至少写一个独立分句，说明躯干、手臂/手部、腿部/脚部和重心。
